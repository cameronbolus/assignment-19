...
function controllerRouter() {
  ...
  _jquery2.default.getJSON('https://api.github.com/users/' + userProfile).then(function (serverRes) {
    console.log(userProfile);
    var profileContainer = document.querySelector('.profile-container');
    var htmlTemplate = createGitHubProfileInfo(serverRes, "Cameron-info");
    profileContainer.innerHTML = htmlTemplate;
  });
  _jquery2.default.getJSON('https://api.github.com/users/' + userProfile + '/repos').then(function (serverRes) {
    console.log(userProfile);
